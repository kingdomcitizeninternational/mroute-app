...
function Portfolio() {
    ...
    return (<>
        <div className={styles.portfolio_section} >
            ...
            <SectionHead title="Create your portfolio today" paragraph="mroute has a variety of features that make it the best place to start trading" />
            ...
            <div className={styles.portfolio_container}>
                <div className={styles.portfolio_contentCon}>
                    ...
                    <div className={styles.portfolio_content} data-aos="fade-up">
                        ...
                        <div className={styles.portfolio_content_writeup}>
                            <h1>Mobile apps</h1>
                            <p>Stay on top of the markets with the mroute app for Android or iOS.</p>
